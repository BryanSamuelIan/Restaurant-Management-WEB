...
@section('content')
    <div class="mx-2 lg:mx-20 flex flex-col lg:flex-row h-auto lg:mt-12 ">
        ...
        <div class="w-full lg:w-2/4">
            ...
            <form id="orderForm" method="POST" action="{{ route('store_order') }}">
                @csrf
                ...
                <div class="flex flex-col md:flex-row justify-end items-end mt-2">
                    <div class="flex items-center pb-4 md:pb-0">
                        ...
                        <input id="totalAmount" class="Totalinput px-2 py-1 border rounded md:mr-4" type="number"
                            value="0" disabled>
                    </div>
                    <div class="flex items-center pb-4 md:pb-0">
                        <label for="table_no" class="mr-2">Table number:</label>
